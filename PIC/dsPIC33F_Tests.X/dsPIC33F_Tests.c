...
struct executionSystemStruct dsPIC33FSysTickExampleSystem;
...
{    
    ...
    dsPIC33FSysTickExampleSystem = CreateExecutionSystemStruct(&setupListHead,&loopListHead,&systickListHead, 1000);
...
{    
    applicationConfig();
    return ExecuteMain(&dsPIC33FSysTickExampleSystem);
}
